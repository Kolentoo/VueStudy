            ...
            <ul class="ocon">
                ...
                <li class="olist">
                    ...
                    <div class="weather">
                        ...
                        <p class="temp"><b>{{weather.temp}}℃</b> <em>{{weather.templow}}℃ ~ {{weather.temphigh}}℃</em></p>
                    </div>
                </li>
            </ul>
        </div>
...
<style scoped>
    ...
    .olist {background:rgba(0,0,0,0.5);padding: 30px;width: 30%;margin:0 3%;}
    .iname {font-size: 24px;font-weight:bold;color:#fff;text-align: center;}
    .keyword {width: 100%;text-align:center;height: 36px;line-height: 36px;font-size: 20px;background: rgba(255,255,255,0.5);border:none;
    border-radius:15px;outline:none;margin-top: 30px;}
